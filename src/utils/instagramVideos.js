...
// Enhanced Instagram content with real video URLs
export const instagramVideos = [
  {
    id: 'ig_video_1',
    title: 'Studio Vibes 🎵',
    description: 'Behind the scenes in the studio - new music coming soon! 🎶',
    instagramUrl: 'https://www.instagram.com/p/YOUR_POST_ID/',
    videoUrl: 'https://video.cdninstagram.com/YOUR_VIDEO_URL.mp4', // Real Instagram video URL
    thumbnailUrl: 'https://scontent.cdninstagram.com/YOUR_THUMBNAIL.jpg',
    embedHtml: `
      <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/p/YOUR_POST_ID/" data-instgrm-version="14">
    ...
    `,
    category: 'studio',
    hashtags: ['#StudioLife', '#BehindTheScenes', '#NewMusic'],
    date: '2024-06-15',
    duration: '0:45',
    views: '12.3K',
    likes: '450'
  },
  {
    ...
    description: 'That feeling when the crowd sings along! 🙌 Last night was incredible!',
    instagramUrl: 'https://www.instagram.com/p/YOUR_POST_ID_2/',
    videoUrl: 'https://video.cdninstagram.com/YOUR_VIDEO_URL_2.mp4',
    thumbnailUrl: 'https://scontent.cdninstagram.com/YOUR_THUMBNAIL_2.jpg',
    embedHtml: `<!-- Instagram embed code for live performance -->`,
    category: 'live',
    hashtags: ['#LiveMusic', '#Concert', '#CrowdSinging'],
    date: '2024-06-10',
    duration: '1:20',
    views: '25.7K',
    likes: '892'
  },
  {
    ...
    description: 'Nothing beats the raw emotion of an acoustic session 🎸✨',
    instagramUrl: 'https://www.instagram.com/p/YOUR_POST_ID_3/',
    videoUrl: 'https://video.cdninstagram.com/YOUR_VIDEO_URL_3.mp4',
    thumbnailUrl: 'https://scontent.cdninstagram.com/YOUR_THUMBNAIL_3.jpg',
    embedHtml: `<!-- Instagram embed code for acoustic session -->`,
    category: 'acoustic',
    hashtags: ['#Acoustic', '#RawEmotion', '#Intimate'],
    date: '2024-05-20',
    duration: '2:15',
    views: '18.5K',
    likes: '623'
